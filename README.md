...
4. 點擊「開始練習」進入答題
5. 輸入答案（鍵盤或語音），答對自動進入下一題
6. 完成後查看時間和排名（練習模式無排名）
...
- **v2.3** (2025年12月20日): 新增練習模式與選擇性練習功能
- **v2.4** (2025年12月20日): 語音輸入功能、自動語音啟動、詳細錯誤回饋
- **v2.4.1** (2025年12月20日): 語音識別優化、修復「四」識別問題、虛擬鍵盤預設關閉
