...
- **練習模式**：72道按九九乘法表順序練習，無時間壓力，純學習導向
- **可選計時器**：避免時間壓力，專注學習
- **大按鈕設計**：符合兒童手指觸控需求
- **視覺回饋**：答對有動畫，鼓勵持續練習
...
### 基本操作
1. 開啟網站，選擇是否顯示計時器
2. 選擇模式：**10題**（漸進式）、**20題**（隨機挑戰）或 **練習模式**（順序學習）
3. 點擊「開始練習」進入答題
4. 輸入答案，答對自動進入下一題
5. 完成後查看時間和排名（練習模式無排名）
...
- **練習模式**：按九九乘法表順序（2×1到9×9），共72題，無計時無排行榜，專注學習
...
- **v2.3** (2025年12月20日): 新增練習模式，支援順序學習
